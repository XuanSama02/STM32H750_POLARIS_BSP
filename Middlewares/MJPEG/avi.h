 ...
 * @brif:    北极星开发板AVI解码
 * @version:
 * 2022/08/23: 实现了北极星开发板AVI格式视频解码
 */

//帧大小,根据自己的内存申请情况,来设置,一般设置这个值等于我们的帧缓存大小即可,默认260KB
#define AVI_MAX_FRAME_SIZE	1024*1024  //最大帧大小,不能超过1MB
...
/**
 * @brief AVI 信息结构体,将一些重要的数据,存放在这里,方便解码
 * 
 */
